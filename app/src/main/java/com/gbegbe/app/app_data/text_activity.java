...
import com.gbegbe.app.app_data.dbhelper.DatabaseHelper;
            ...
            public void onClick(View view) {
                if (text_activity.this.f210qu.length() > 0) {
                    ...
                    try {
                        ...
                        readJSONFeedTask.execute(new String[]{"https://translate.googleapis.com/translate_a/single?client=gtx&sl=" + Languages.getsptrCode(text_activity.this.spinner.getSelectedItemPosition()) + "&tl=" + Languages.getsptrCode(text_activity.this.spinner2.getSelectedItemPosition()) + "&dt=t&ie=UTF-8&oe=UTF-8&q=" + encode});
